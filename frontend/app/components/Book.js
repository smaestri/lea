	...
	render() {
		...
		return (
			<div className="book">
				...
				<div><label className="book-preteur">Prêteur: </label><Link
					to={'user-detail/' + this.props.book.userId + '/' + this.props.previousPage }><span>{this.props.book.preteur}</span></Link>
				</div>}
				{!userConnected && (this.props.previousPage == 'listBook' || this.props.previousPage == 'userDetail') &&
				<div><label
				...
				<div className="avisBook">
					<div className="moyenneNote">Moyenne des avis ({this.props.book.avis.length}
						avis)
					</div>
				...
				<div className="linkBook"><Link
					to={'book-detail/' + this.props.book.id + '/' + this.props.previousPage }>Voir
					les avis</Link></div>
				...
				<div className="buttonBook">
					...
					{!userConnected &&
					<span>Connectez ou inscrivez-vous pour emprunter ce livre!</span>}
					{(!(this.props.previousPage == 'myBooks') && this.props.book.statut != 'FREE') &&
