    ...
    render() {
        ...
        return (
            <div className="book">
                ...
                {userConnected && (!(this.props.previousPage == 'myBooks') && this.props.book.statut =='FREE' && !this.props.book.empruntable) && !this.props.book.pending && <div className="buttonBook"><Button title="Ajoutez cette personne comme ami afin d'échanger des livres avec elle!" bsStyle="primary" bsSize="small" onClick={this.savePendingFriend}>Ajouter comme ami</Button></div>}
                {userConnected && (!(this.props.previousPage == 'myBooks') && this.props.book.statut =='FREE' && !this.props.book.empruntable) && this.props.book.pending && <div>Vous avez ajouté cette personne comme ami</div>}
                ...
                <div className="buttonBook">
                    ...
                    {userConnected && (!(this.props.previousPage == 'myBooks') && this.props.book.statut =='FREE' && this.props.book.empruntable) && !this.props.book.pending && <Button bsStyle="primary" bsSize="small" onClick={this.handleLoan}>Emprunter</Button>}
