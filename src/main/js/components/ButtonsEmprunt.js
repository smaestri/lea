...
class ButtonsEmprunt extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {motifRefus: '', disableAcceptButton: false, disableSendButton: false, disableCloseButton: false, showModal: false};
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                {displayAcceptButton && <Button bsStyle="primary" bsSize="small" onClick={this.showModalRefus}>Refuser</Button>}
                ...
                <Modal show={this.state.showModal} onHide={this.closeModalRefus}>
                    ...
                    <Modal.Body>
                        ...
                        <FormControl componentClass="textarea" placeholder="Motif du refus" onChange={this.handleChange} />
                    </Modal.Body>
                    <Modal.Footer>
                        <Button onClick={this.closeModalRefus} bsStyle="primary" bsSize="small">Close</Button>
                        {displayAcceptButton && <Button bsStyle="primary" bsSize="small" onClick={this.refuseLoan} disabled={this.state.disableAcceptButton}>Valider</Button>}
                    </Modal.Footer>
                </Modal>
            </div>
        )
