            ...
            <div class="col-md-2 text-center">
                ...
                <div class="bloc_button">
                    <a class="editBook" href="<c:url value="/livres/edit/${livre.id}" /> ">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-emprunt" data-livre="${livre.id}" data-proprietaire="${livre.userId}">Modifier</button>
                    </a>
                    <a class="deleteBook" data-livre="${livre.id}" href="#"  >
                        <button type="button" style="margin-top:5px;" class="btn btn-primary" data-toggle="modal" data-target="#modal-emprunt" data-livre="${livre.id}" data-proprietaire="${livre.userId}">Supprimer</button>
                    </a><br/>
                </div>
            </div>
        </c:forEach>
